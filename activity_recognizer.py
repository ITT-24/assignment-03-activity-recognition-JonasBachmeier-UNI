...
def train_model():
    # load the data
    rowing1 = pd.read_csv('data/johannes-rowing-1.csv')
    rowing2 = pd.read_csv('data/johannes-rowing-2.csv')
    rowing3 = pd.read_csv('data/johannes-rowing-3.csv')
    rowing4 = pd.read_csv('data/johannes-rowing-4.csv')
    rowing5 = pd.read_csv('data/johannes-rowing-5.csv')

    rowing_full = pd.concat([rowing1, rowing2, rowing3, rowing4, rowing5])

    lifting1 = pd.read_csv('data/johannes-lifting-1.csv')
    lifting2 = pd.read_csv('data/johannes-lifting-2.csv')
    lifting3 = pd.read_csv('data/johannes-lifting-3.csv')
    lifting4 = pd.read_csv('data/johannes-lifting-4.csv')
    lifting5 = pd.read_csv('data/johannes-lifting-5.csv')

    lifting_full = pd.concat([lifting1, lifting2, lifting3, lifting4, lifting5])

    running1 = pd.read_csv('data/johannes-running-1.csv')
    running2 = pd.read_csv('data/johannes-running-2.csv')
    running3 = pd.read_csv('data/johannes-running-3.csv')
    running4 = pd.read_csv('data/johannes-running-4.csv')
    running5 = pd.read_csv('data/johannes-running-5.csv')

    running_full = pd.concat([running1, running2, running3, running4, running5])

    jumpingjacks1 = pd.read_csv('data/johannes-jumpingjacks-1.csv')
    jumpingjacks2 = pd.read_csv('data/johannes-jumpingjacks-2.csv')
    jumpingjacks3 = pd.read_csv('data/johannes-jumpingjacks-3.csv')
    jumpingjacks4 = pd.read_csv('data/johannes-jumpingjacks-4.csv')
    jumpingjacks5 = pd.read_csv('data/johannes-jumpingjacks-5.csv')
